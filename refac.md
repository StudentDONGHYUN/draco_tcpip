...
수행할 작업을 3~7개 항목의 간결한 체크리스트로 먼저 제시하되, 구현 세부사항이 아닌 개념적 수준으로 정리한다.
